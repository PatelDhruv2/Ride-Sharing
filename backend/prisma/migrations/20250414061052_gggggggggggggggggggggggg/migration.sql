/*
  ...
  - The values [SCHEDULED,BOOKED,CANCELLED] on the enum `RideStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "RideStatus_new" AS ENUM ('IN_PROGRESS', 'COMPLETED', 'ACCEPTED', 'REJECTED', 'PENDING');
